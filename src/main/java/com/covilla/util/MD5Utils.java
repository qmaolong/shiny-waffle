...
public class MD5Utils {
	...
	public static void main(String[] args) {
		for (int i = 0; i < 6; i++) {
			System.out.println(getMD5Hash(UUID.randomUUID().toString()));
		}
	}
}
